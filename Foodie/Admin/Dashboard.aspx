                ...
                <div class="row">
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                                            <a href="OrderStatus.aspx" class="text-c-green f-16 icofont icofont-eye-alt m-r-10">View Details</a>
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                                            <a href="OrderStatus.aspx" class="text-c-yellow f-16 icofont icofont-eye-alt m-r-10">View Details</a>
                                        </span>
                                    </div>
                                </div>
                            </div>
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card widget-card-1">
                            <div class="card-block-small">
                                ...
                                <div>
                                    <span class="f-left m-t-10 text-muted">
                                        <a href="Report.aspx" class="text-c-green f-16 icofont icofont-eye-alt m-r-10">View Details</a>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card widget-card-1">
                            <div class="card-block-small">
                                <i class="icofont icofont-support-faq bg-c-yellow card-icon"></i>
                                <span class="text-c-yellow f-w-600">Feedbacks</span>
                                <h4><% Response.Write(Session["contact"]); %></h4>
                                <div>
                                    <span class="f-left m-t-10 text-muted">
                                        <a href="Contacts.aspx" class="text-c-yellow f-16 icofont icofont-eye-alt m-r-10">View Details</a>
                                    </span>
                                </div>
                            </div>
                        </div>
